...
const projects = [
  {
    ...
    results: ["Increased client sales by 40%", "Reduced cart abandonment by 25%", "Improved page load times by 60%"],
    lessonsLearned:
  ...
  },
  {
    ...
    description: "A responsive portfolio website built with Next.js and Tailwind CSS to showcase my work and skills.",
    image: "/placeholder.svg?height=400&width=600",
  ...
  },
  {
    ...
    description: "A weather forecast application that provides real-time weather data and forecasts for any location.",
    image: "/placeholder.svg?height=400&width=600",
